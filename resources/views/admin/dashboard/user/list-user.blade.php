        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <h2 class="text-bold-700 mt-1">{{$customerUserStatistics['totalRoles']}}</h2>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <h2 class="text-bold-700 mt-1">{{$customerUserStatistics['totalUserActive']}}</h2>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <h2 class="text-bold-700 mt-1">{{$customerUserStatistics['totalUserDeactive']}}</h2>
    ...
    <section id="data-list-view" class="data-list-view-header">
        ...
        <div class="table-responsive">
            ...
            <table class="table data-thumb-view">
                ...
                <tbody>
                    <?php 
                        foreach ($listCustomerUser as $customer) {
                            ?>
                                <tr>
                                    ...
                                    <td class="product-name"><div class="d-flex justify-content-left align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            </a><small class="emp_post text-muted">{{ $customer['email_customer'] }}</small></div></div></td>
                                    ...
                                    <td >
                                        {{ isset($customer['user_login']['username']) ? $customer['user_login']['username'] : ''  }}
                                        {{-- @if($customer['id_user']) 
                                    ...
                                    <td class="product-action">
                                        ...
                                        <input type="hidden" name="username" value="{{ isset($customer['user_login']['username']) ? $customer['user_login']['username'] : ''  }}">
        ...
        <div class="add-new-data-sidebar" id="form-add-popup-left">
            ...
            <form  method="post" id="add-customer" action="{{ route('user.postAddCustomerUser') }}"  enctype="multipart/form-data" >
                ...
                <div class="add-new-data">
                    ...
                    <div class="data-items pb-3" style=" overflow-y: scroll; ">
                        <div class="data-fields px-2 mt-1">
                            <div class="row">
                                
                                <div class="col-sm-12 data-field-col">
                                    <label for="data-name"><b>Tài khoản đăng nhập</b></label>
                                    <input type="text" required  minlength="5" class="form-control" name="username">
                                </div>
                                <div class="col-sm-6 data-field-col">
                                    <label for="data-name"><b>mật khẩu</b></label>
                                    <input type="password" required  minlength="5" class="form-control" name="password">
                                </div>
                                <div class="col-sm-6 data-field-col">
                                    <label for="data-name"><b>Xác nhận mật khẩu</b></label>
                                    <input type="password" required minlength="5" class="form-control" name="password_confirmation">
                                </div>
                                ...
                                <div class="col-sm-12 data-field-col">
                                    <label for="data-category"> Vai trò </label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input  class="multi with-preview" name="customer_avatar[]" type="file" data-maxfile="100"  maxlength="1"  accept="svg|jpg|webp|png|jpeg" />
                                </div>
                                <div class="col-sm-12 data-field-col">
        ...
        <!-- update user  sidebar starts -->
        <div class="add-new-data-sidebar" id="form-update-popup-left">
            <div class="overlay-bg"></div>
            <form  method="post" id="update-customer" action="{{ route('user.postUpdateCustomerUser') }}"   enctype="multipart/form-data" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                <input type="hidden" name="id" value="" />
                <div class="add-new-data">
                    <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                        <div>
                            <h4 class="text-uppercase">Thay đổi thông tin</h4>
                        </div>
                        <div class="hide-data-sidebar">
                            <i class="feather icon-x"></i>
                        </div>
                    ...
                    <div class="data-items pb-3" style=" overflow-y: scroll; ">
                        <div class="data-fields px-2 mt-1">
                            <div class="row">
                                ...
                                <div class="col-sm-12 data-field-col">
                                    <label for="data-name"><b>Mật khẩu cũ</b></label>
                                    <input type="password" minlength="5" class="form-control"  value="" name="old_password">
                                </div>

                                <div class="col-sm-6 data-field-col">
                                    <label for="data-name"><b>mật khẩu mới</b></label>
                                    <input type="password" minlength="5" class="form-control"  value="" name="password">
                                </div>
                                <div class="col-sm-6 data-field-col">
                                    <label for="data-name"><b>Xác nhận mật khẩu mới</b></label>
                                    <input type="password" minlength="5" class="form-control"  value="" name="password_confirmation">
                                </div>
                                ...
                                <div class="col-sm-12 data-field-col">
                                    <label for="data-phone">Email</label>
                                    <input type="email" required readonly placeholder="examle.com" class="form-control" name='email_customer'>
                                </div>

                                <div class="col-sm-12 data-field-col">
                                    <label for="data-phone">Điện thoại</label>
                                    <input type="tel" required placeholder="#########" class="form-control input-number" name='phone'>
                                </div>
                                <div class="col-sm-12 data-field-col">
                                    <label for="data-category"> Vai trò </label>
                                    <select class="form-control" required id="data-role" name="role">
                    ...
                    <div class="add-data-footer d-flex justify-content-around px-3 mt-2">
                        <div class="add-data-btn">
                            <button type="submit" value="create" class="btn btn-success">Cập nhật</button>
                        </div>
                        <div class="cancel-data-btn">
                            <button class="btn btn-outline-danger">Đóng</button>
                        </div>
        ...
        <div class="add-new-data-sidebar" id="form-delete-popup-left">
            <div class="overlay-bg"></div>
            <form  method="POST" class="dropzone dropzone-area" id="delete-customer" action="{{ route('user.deleteCustomerUser','') }}" urlAction="{{ route('user.deleteCustomerUser','') }}">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
                <div class="add-new-data">
                    <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
