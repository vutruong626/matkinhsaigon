...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Cập nhật đối tác</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{ route('partner.postUpdatePartner', $partner->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Link</label>
                                        <div class="controls">
                                            <input type="text" name="alias" class="form-control" id="slug" value="{{ $partner->alias }}">
                                        </div>
                                        @if ($errors->has('alias'))
                                        ...
                                        <div class="controls">
                                            <div class="d-flex align-items-center mb-1">
                                                <div class="input-group input-group-lg">
                                                    <input type="number" name="weight" class="touchspin" value="{{ $partner->weight }}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" required id="data-status" name='hidden'>
                                                <option value="1" {{ $partner->hidden === 1 ? 'selected="selected"' : '' }}>Hoạt động</option>
                                                <option value="0" {{ $partner->hidden === 0 ? 'selected="selected"' : '' }}>Vô hiệu</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" required id="data-status" name='city'>
                                                ...
                                                <option value="{{ $itemArea->id }}" {{ $itemArea->id === $partner->city ? 'selected="selected"' : '' }}>{{ $itemArea->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label>Địa chỉ:</label>
                                        <div class="controls">
                                            <input type="text" name="address" class="form-control get-map address" value="{{ $partner->address }}">
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                style="background-image: url({{ $partner->logo ? $partner->getImage() : 'http://i.pravatar.cc/500?img=7' }});width: 100%;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
