                ...
                <div class="modal-body">
                    <div class="form-body">
                        <div class="row">
                                        ...
                                        <div class="controls">
                                            <div class="d-flex align-items-center mb-1">
                                                <div class="input-group input-group-lg">
                                                    <input type="number" name="weight" class="touchspin weight" value="1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn bg-danger mr-1 mb-1 waves-effect waves-light submit-model-all"
                                    data-host="{{ route('material.postAddMaterial') }}"
