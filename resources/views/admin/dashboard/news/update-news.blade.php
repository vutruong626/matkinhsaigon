        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{ route('news.postUpdateNews', $news->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="controls">
                                            <fieldset class="form-label-group mb-0">
                                                <textarea name="description" id="editorDescription"
                                                    class="form-control char-textarea" rows="3" required>{{ $news->description }}</textarea>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="controls">
                                            <fieldset class="form-label-group mb-0">
                                                <textarea name="content" id="editorContent"
                                                    class="form-control char-textarea" rows="3" required>{{ $news->content }}</textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Từ khóa:</label>
                                        <div class="controls">
                                            <input type="text" name="kw" class="form-control" value="{{ $news->kw }}">
                                        </div>
                                        @if ($errors->has('kw'))
                                        ...
                                        <div class="controls">
                                            <fieldset class="form-label-group mb-0">
                                                <textarea name="meta_description" class="form-control char-textarea"
                                                    rows="3">{{ $news->meta_description }}</textarea>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="controls">
                                            <div class="d-flex align-items-center mb-1">
                                                <div class="input-group input-group-lg">
                                                    <input type="number" name="weight" class="touchspin" value="{{ $news->weight }}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" required id="data-status" name='hidden'>
                                                <option value="1" {{ $news->hidden === 1 ? 'selected="selected"' : '' }}>Hoạt động</option>
                                                <option value="0" {{ $news->hidden === 0 ? 'selected="selected"' : '' }}>Vô hiệu</option>
                                            </select>
                                        </div>
