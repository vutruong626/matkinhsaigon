...
<section id="data-list-view" class="data-list-view-header">
    ...
    <div class="table-responsive">
        ...
        <table class="table data-thumb-view" data-url-create="{{ route('category.getCreateCategory') }}">
            <thead>
                <tr>
                    <th></th>
                    <th>Tên</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-action">
                        <a href="{{ route('category.getUpdateCategory', $itemParentCategories->id) }}" class="btn btn-info btn-sm">Sửa</a>
                        {!! Form::open(['method' => 'DELETE','route' => ['category.deleteCategory', $itemParentCategories->id],'style'=>'display:inline']) !!}
                ...
                <tr>
                    ...
                    <td class="product-action">
                        <a href="{{ route('category.getUpdateCategory', $itemChillParent->id) }}" class="btn btn-info btn-sm">Sửa</a>
                        {!! Form::open(['method' => 'DELETE','route' => ['category.deleteCategory', $itemChillParent->id],'style'=>'display:inline']) !!}
                        {!! Form::submit('Delete', ['class' => 'btn btn-danger btn-sm']) !!}
                        {!! Form::close() !!}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="product-action">
                        <a href="{{ route('category.getUpdateCategory', $itemChildLevelParent->id) }}" class="btn btn-info btn-sm">Sửa</a>
                        {!! Form::open(['method' => 'DELETE','route' => ['category.deleteCategory', $itemChildLevelParent->id],'style'=>'display:inline']) !!}
                        {!! Form::submit('Delete', ['class' => 'btn btn-danger btn-sm']) !!}
                        {!! Form::close() !!}
                    </td>
                </tr>
