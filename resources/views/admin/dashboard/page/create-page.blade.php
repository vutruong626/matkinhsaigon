...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Tạo Mới Quy Định</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{ route('page.postAddPage') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" id="data-status" name='type'>
                                                <option value="0">Chính sách và quy định</option>
                                                <option value="1">Quy định bảo hành</option>
                                            </select>
                                        </div>
