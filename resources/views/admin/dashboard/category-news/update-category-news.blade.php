        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{ route('catagoryNews.postUpdateCategoryNews', $category->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group create-catagory">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                style="background-image: url({{ $category->icon ? $category->getIconImages() : 'http://i.pravatar.cc/500?img=7' }});">
                                            </div>
                                        </div>
                                    </div>
                                </div>
